package ap14.hibernate.productList;
...
import ap.commons.hibernate.entities.EProduct;
import ap.commons.hibernate.entities.EProductAnnotated;

/**
 * Servlet implementation class InitHibernateServlet
 */
@WebServlet("/ListProductsUsingHibernate")
public class ListProductUsingHibernateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ListProductUsingHibernateServlet() {
		super();
