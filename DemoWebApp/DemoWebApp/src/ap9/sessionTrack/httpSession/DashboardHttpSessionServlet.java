package ap9.sessionTrack.httpSession;
 ...
 */
@WebServlet(name="DashboardHttpSessionServlet", urlPatterns="/dashboardHttpSession")
public class DashboardHttpSessionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userId == null) {
            ...
            out.println("<a href='logouHttpSession'>Logout of session</a><br>");
		}
